...
public class CookieAuthenticationStateProvider : AuthenticationStateProvider
{
    ...
    public async Task<ApiResponse> Register(string email, string password)
    {
        try
        {
            ...
            if (result.IsSuccessStatusCode) return new ApiResponse { Success = true };
            ...
            foreach (var errorEntry in errorList.EnumerateObject()) errors += errorEntry.Value.GetString()!;
